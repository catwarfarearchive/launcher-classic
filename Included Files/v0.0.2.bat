...
:Check-LP
if exist "..\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe" (
    GOTO Installed-LP
) else (
    mkdir "..\Cat Warfare Pre-Alpha Archive\v0.0.2"
    GOTO NotInstalled
)

:Check-P
if exist "Data\v0.0.2\Build2.exe" (
    GOTO Installed-P
) else (
    mkdir "Data\v0.0.2"
    GOTO NotInstalled
...
:Check-NP
if exist "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
::----------------------------------------------------------
:Installed
;Title [Launching] Cat Warfare Pre-Alpha (v0.0.2)
START "" "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe"
exit

:Installed-P
;Title [Launching] Cat Warfare Pre-Alpha (v0.0.2)
START "" "Data\v0.0.2\Build2.exe"
exit

:Installed-LP
;Title [Launching] Cat Warfare Pre-Alpha (v0.0.2)
START "" "..\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe"
exit
::----------------------------------------------------------

::----------------------------------------------------------
:NotInstalled
;Title [Downloading] Cat Warfare Pre-Alpha (v0.0.2)
...
7zr.exe x "%tmp%\CWPAL-Temp\Cat.Warfare.v0.0.2.Pre-Alpha.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\v0.0.2"
...
mkdir "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\v0.0.2"
GOTO Extract-NP
)
...
:Extract-LP
7zr.exe x "%tmp%\CWPAL-Temp\Cat.Warfare.V0.0.2.Pre-Alpha.7z" -o"..\Cat Warfare Pre-Alpha Archive\v0.0.2"
GOTO End
