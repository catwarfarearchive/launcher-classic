...
:Check-NP
if exist "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
START "" "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.2\Build2.exe"
exit
...
mkdir "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.2"
GOTO Extract-NP
)
