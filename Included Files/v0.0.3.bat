...
:Check-NP
if exist "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.3\CatWarfare_PreAlphaBuild_3.exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
START "" "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.3\CatWarfare_PreAlphaBuild_3.exe"
exit

:Installed-P
;Title [Launching] Cat Warfare Pre-Alpha (v0.0.3)
START "" "Data\v0.0.3\CatWarfare_PreAlphaBuild_3.exe"
exit
::----------------------------------------------------------
...
mkdir "%userprofile%\Documents\Cat Warfare Pre-Alpha Archive\v0.0.3"
GOTO Extract-NP
)
